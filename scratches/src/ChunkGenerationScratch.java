...
public class ChunkGenerationScratch extends PApplet {
    public static void main(String[] args) {
        PApplet.main("ChunkGenerationScratch", args);
    }

    int nPlayerX, nPlayerY;
    private int CHUNK_SIZE = 32;
    private int TILE_SIZE;
    int nMinDivisor = 4096; //Used for testing boundaries
    Map mapMap;
    ...
    class Chunk {
        ...
        public void generateTerrain() {
            float fWidthOffset = 0, fHeightOffset = 0, fPersistence = (float) 0.08;
